...
var GeoService = (function () {
    ...
    GeoService.prototype.postLocation = function () {
        navigator.geolocation.getCurrentPosition(this.handlePositionSuccess.bind(this), this.handlePositionError.bind(this), this.positionOptions);
    };
    GeoService.prototype.handlePositionSuccess = function (pos) {
        var coor = pos.coords;
